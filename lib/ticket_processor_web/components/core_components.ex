defmodule TicketProcessorWeb.CoreComponents do
  @moduledoc """
  ...
  attr(:class, :any)
  attr(:variant, :string, values: ~w(primary danger outline))
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TicketProcessorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TicketProcessorWeb.Gettext, "errors", msg, opts)
    end
  end
